...
4. **Gain a file-write primitive:** With sufficient database privileges, a MySQL injection or authenticated query may use `UNION ... INTO OUTFILE` to write a file. This requires the database account's `FILE` privilege, a permitted destination, and knowledge of the web root.
